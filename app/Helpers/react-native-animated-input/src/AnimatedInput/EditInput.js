...
const EditAnimatedInput = ({
    ...
    const animationView = useCallback(() => {
        const sizeShow = 36 + labelFontSize + inputFontSize;
        const sizeHide = 18 + labelFontSize;
        const inputAdjust = {
...
EditAnimatedInput.defaultProps = {
    valid: true,
    disabled: false,
    value: "",
    styleInput: {},
...
export default EditAnimatedInput;
