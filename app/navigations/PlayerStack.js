...
export function PlayerStack() {
    const tabBarLabel = (focused) => ({
        ...
        fontSize: focused ? customTheme.fontSizes.size_8 : customTheme.fontSizes.size_12
        ...
        >
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => {
                        return <FontAwesomeIcon icon={faUserFriends} color={customTheme.colors.light} style={{
                            opacity: focused ? 1 : 0.4
                        }} />
                    }
                }}
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => {
                        return <FontAwesomeIcon icon={faMessage} color={customTheme.colors.light} style={{
                            opacity: focused ? 1 : 0.4
                        }} />
                    }
                }}
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => {
                        return <FontAwesomeIcon icon={faUser} color={customTheme.colors.light} style={{
                            opacity: focused ? 1 : 0.4
                        }} />
                    }
                }}
