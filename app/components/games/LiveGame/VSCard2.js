...
function TeamCard({ score, name, logoImg, finalScore, isHome = false }) {
  return (
    <View
      style={[styles.horizentalRow, styles.gap10, !isHome && styles.reverse]}>
      ...
      <Text style={styles.totalScore}>{finalScore}</Text>
    </View>
  );
}
