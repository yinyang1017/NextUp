        ...
        <View style={{
        ...
        }}>
            {
                _.map(profileMenuOptions, (item, index) => {
                    return <Pressable onPress={item.onPress} key={index} style={{
                        ...
                        <View style={{
                            ...
                            <FontAwesomeIcon icon={item?.icon} color={customTheme.colors.white} size={customTheme.fontSizes.size_28} />
                            <Text style={{
                                color: customTheme.colors.white,
                        ...
                        <View style={{
                            ...
                            <FontAwesomeIcon icon={faAngleRight} color={customTheme.colors.white} />
                        </View>
